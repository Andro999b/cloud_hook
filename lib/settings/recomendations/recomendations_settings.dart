...
class RecomendationsSettingsSection extends StatelessWidget {
  const RecomendationsSettingsSection({super.key});
...
class _RecomendationsSettingsList extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final suppliersOrder = ref.watch(
        recomendationSettingsProvider.select((value) => value.suppliersOrder));
    ...
    return Container(
      ...
      child: ReorderableListView(
        ...
        onReorder: (oldIndex, newIndex) {
          ref
              .read(recomendationSettingsProvider.notifier)
...
class _RecomendationsSettingsItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final padding = getPadding(context);
    final config = ref.watch(recomendationSettingsProvider
        .select((value) => value.getConfig(supplier)));
